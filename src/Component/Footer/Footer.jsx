                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid  gap-8 py-8 lg:grid-cols-8">
                        <div className="mb-0 col-span-full lg:col-span-3 ">
                            ...
                            <h1 className="text-3xl font-bold">Pagedone</h1>
                            <p className="py-8  text-gray-500 text-wrap">Trusted in more than 100 countries & 5 million customers. Follow us on social media.</p>
                        ...
                        <div className="w-full text-center lg:w-auto lg:text-left col-span-full sm:order-last sm:col-span-4 md:col-span-4 lg:order-none lg:col-span-1">
                            ...
                            <ul className="text-gray-600 transition-all duration-500  ">
                                ...
                                <li className="sm:mb-6"><a href="" className=" text-gray-600 hover:text-gray-900">Features</a></li>
                            </ul>
                        </div>
                        {/* <!--End Col--> */}
                        <div className="w-full text-center lg:w-auto lg:text-left col-span-full sm:col-span-4 md:col-span-4 lg:col-span-2 ">
                            ...
                            <div className="lg:flex flex-col items-center lg:items-start">
                                <input type="text" className="sm:w-full h-12 border border-gray-300 rounded-full py-2.5 px-5 shadow-sm text-gray-800 mb-5 text-center lg:text-left placeholder:text-gray-400 focus:outline-none focus:border-gray-500" placeholder="Your email here.." />
