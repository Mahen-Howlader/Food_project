                ...
                <div className="max-w-screen-xl m-0 sm:m-10 bg-white shadow sm:rounded-lg flex justify-center flex-1">
                    ...
                    <div className="flex-1 bg-green-100 text-center hidden lg:flex">
                        <div
                            ...
                            style={{
                                backgroundImage:
                                    'url("https://storyset.com/illustration/login/bro#default&hide=&hide=false")'
                            }}
                        >

                            <a href='https://postimg.cc/RqPcfcDs' target='_blank'><img src='https://i.postimg.cc/c4WTphMS/Mobile-login-pana.png' border='0' alt='Mobile-login-pana' /></a>
                        </div>
                    </div>
                </div>
            </div>
